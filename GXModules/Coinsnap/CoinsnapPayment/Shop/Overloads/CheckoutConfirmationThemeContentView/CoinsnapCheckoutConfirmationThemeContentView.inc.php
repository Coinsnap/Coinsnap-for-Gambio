...
class CoinsnapCheckoutConfirmationThemeContentView extends CoinsnapCheckoutConfirmationThemeContentView_parent
{
	public function prepare_data()
	{
		...
		$configurationStorage = MainFactory::create('CoinsnapStorage');
