...
class CoinsnapRefundEntity {
	 ...
	 * @return $this
	 */
	public function setId(int $id): CoinsnapRufundEntity
	{
		$this->id = $id;
		return $this;
	}
	 ...
	 * @return $this
	 */
	public function setRefundId(int $refundId): CoinsnapRufundEntity
	{
	 ...
	 * @return $this
	 */
	public function setOrderId(int $orderId): CoinsnapRufundEntity
	{
	 ...
	 * @return $this
	 */
	public function setAmount(float $amount): CoinsnapRufundEntity
	{
		$this->amount = $amount;
		return $this;
	}
	 ...
	 * @return $this
	 */
	public function setCreatedAt(string $createdAt): CoinsnapRufundEntity
	{
