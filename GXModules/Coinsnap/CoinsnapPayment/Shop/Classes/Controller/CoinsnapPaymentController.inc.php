...
class CoinsnapPaymentController extends HttpViewController {
    /**
     * @throws Exception
     */
	...
	$content = $this->_render(
	    'GXModules/Coinsnap/CoinsnapPayment/Shop/Themes/All/checkout_payment_coinsnap.html',
	    [
		'appJsUrl' => 'GXModules/Coinsnap/CoinsnapPayment/Shop/Templates/All/Javascript/extenders/coinsnap-app.js',
	...
	for ($j = 0; $j < count($t_gm_gprint_data); $j++) {
	    $t_attributes_array[] = [
		'option' => $t_gm_gprint_data[$j]['NAME'],
